#ifndef __agstDk5xZXDcm4MOHpL6HC_h__
#define __agstDk5xZXDcm4MOHpL6HC_h__
...
#ifndef struct_tag_n5PXQzpje1ScqXePwEm4jH
#define struct_tag_n5PXQzpje1ScqXePwEm4jH

struct tag_n5PXQzpje1ScqXePwEm4jH
{
...
#endif                                 /*struct_tag_n5PXQzpje1ScqXePwEm4jH*/

#ifndef typedef_robotics_manip_internal_CollisionSet
#define typedef_robotics_manip_internal_CollisionSet

typedef struct tag_n5PXQzpje1ScqXePwEm4jH robotics_manip_internal_CollisionSet;
...
typedef struct tag_rHHvNgfpb6xtLaCol8pZFD rigidBodyJoint;

#endif                                 /*typedef_rigidBodyJoint*/

#ifndef struct_tag_x9LKlipadtwOGURwmHXUMD
#define struct_tag_x9LKlipadtwOGURwmHXUMD

struct tag_x9LKlipadtwOGURwmHXUMD
{
...
#endif                                 /*struct_tag_x9LKlipadtwOGURwmHXUMD*/

#ifndef typedef_robotics_manip_internal_RigidBody
#define typedef_robotics_manip_internal_RigidBody

typedef struct tag_x9LKlipadtwOGURwmHXUMD robotics_manip_internal_RigidBody;

#endif                                 /*typedef_robotics_manip_internal_RigidBody*/

#ifndef struct_tag_NgxlCQpcrgjyIaf2a4vNKF
#define struct_tag_NgxlCQpcrgjyIaf2a4vNKF

struct tag_NgxlCQpcrgjyIaf2a4vNKF
{
  real_T Index;
  char_T NameInternal[5];
  rigidBodyJoint JointInternal;
  real_T ParentIndex;
  robotics_manip_internal_CollisionSet CollisionsInternal;
};

#endif                                 /*struct_tag_NgxlCQpcrgjyIaf2a4vNKF*/

#ifndef typedef_robotics_manip_internal_RigidBody_1
#define typedef_robotics_manip_internal_RigidBody_1

typedef struct tag_NgxlCQpcrgjyIaf2a4vNKF robotics_manip_internal_RigidBody_1;

#endif                                 /*typedef_robotics_manip_internal_RigidBody_1*/

#ifndef struct_tag_djhMzdQ2CcaNc9Ek7JFTnE
#define struct_tag_djhMzdQ2CcaNc9Ek7JFTnE

struct tag_djhMzdQ2CcaNc9Ek7JFTnE
{
  real_T NumBodies;
  robotics_manip_internal_RigidBody Base;
  robotics_manip_internal_RigidBody_1 *Bodies[7];
  real_T PositionNumber;
  real_T VelocityNumber;
  real_T PositionDoFMap[14];
  robotics_manip_internal_RigidBody_1 _pobj0[7];
};

#endif                                 /*struct_tag_djhMzdQ2CcaNc9Ek7JFTnE*/

#ifndef typedef_robotics_manip_internal_RigidBodyTree
#define typedef_robotics_manip_internal_RigidBodyTree

typedef struct tag_djhMzdQ2CcaNc9Ek7JFTnE robotics_manip_internal_RigidBodyTree;

#endif                                 /*typedef_robotics_manip_internal_RigidBodyTree*/

#ifndef struct_tag_BH655HW1rx0UGWFNpldocH
#define struct_tag_BH655HW1rx0UGWFNpldocH

struct tag_BH655HW1rx0UGWFNpldocH
{
  int32_T isInitialized;
  robotics_manip_internal_RigidBodyTree TreeInternal;
};

#endif                                 /*struct_tag_BH655HW1rx0UGWFNpldocH*/
...
typedef struct tag_BH655HW1rx0UGWFNpldocH
  robotics_slmanip_internal_block_GetJacobianBlock;

#endif                                 /*typedef_robotics_slmanip_internal_block_GetJacobianBlock*/

#ifndef struct_tag_s2V6ewgUQ0PKnqz5J3AhAZ
#define struct_tag_s2V6ewgUQ0PKnqz5J3AhAZ

struct tag_s2V6ewgUQ0PKnqz5J3AhAZ
{
  real_T NameLength;
  uint8_T Name[5];
  real_T ParentIndex;
...
#endif                                 /*struct_tag_s2V6ewgUQ0PKnqz5J3AhAZ*/

#ifndef typedef_s2V6ewgUQ0PKnqz5J3AhAZ
#define typedef_s2V6ewgUQ0PKnqz5J3AhAZ

typedef struct tag_s2V6ewgUQ0PKnqz5J3AhAZ s2V6ewgUQ0PKnqz5J3AhAZ;

#endif                                 /*typedef_s2V6ewgUQ0PKnqz5J3AhAZ*/
...
#ifndef typedef_swZ9yUSx6BPXU2zxjUKEQzD
#define typedef_swZ9yUSx6BPXU2zxjUKEQzD

typedef struct tag_swZ9yUSx6BPXU2zxjUKEQzD swZ9yUSx6BPXU2zxjUKEQzD;

#endif                                 /*typedef_swZ9yUSx6BPXU2zxjUKEQzD*/

#ifndef struct_tag_sbQSF4HBA32jpqIqoNo6ZWG
#define struct_tag_sbQSF4HBA32jpqIqoNo6ZWG

struct tag_sbQSF4HBA32jpqIqoNo6ZWG
{
  real_T NumBodies;
  real_T Gravity[3];
  ...
  s2V6ewgUQ0PKnqz5J3AhAZ Bodies[8];
  swZ9yUSx6BPXU2zxjUKEQzD Joints[8];
};

#endif                                 /*struct_tag_sbQSF4HBA32jpqIqoNo6ZWG*/

#ifndef typedef_sbQSF4HBA32jpqIqoNo6ZWG
#define typedef_sbQSF4HBA32jpqIqoNo6ZWG

typedef struct tag_sbQSF4HBA32jpqIqoNo6ZWG sbQSF4HBA32jpqIqoNo6ZWG;

#endif                                 /*typedef_sbQSF4HBA32jpqIqoNo6ZWG*/
...
typedef struct tag_8EP4ctv7s0SDnh3V6WCLOG cell_wrap;
...
typedef struct emxArray_tag_8EP4ctv7s0SDnh3V6W emxArray_cell_wrap;
...
typedef struct tag_BtOuuAxQdlMdLR8oN4rWaD c_cell;
...
typedef struct tag_bVpmb8DLX7RElZONckYfQE d_cell;
...
typedef struct tag_MEfs58t5wwv9RfcKxMHxyE e_cell;
...
typedef struct tag_1cYHcz4c2P8lVycIPipM4G f_cell;
...
typedef struct tag_dJ5OohqsvmaBtsn73czh7G g_cell;
...
typedef struct tag_odqOZ4yZvm6YZ58BrLh67E h_cell;
...
typedef struct tag_AxxjifeXZC3YZqPCwJZnqC i_cell;
...
typedef struct tag_HI6nVq5wf7BsUENZR0IheC j_cell;
...
typedef struct tag_xzcDJVCDY5ygSyoXSlHfkH d_cell_wrap;

#endif                                 /*typedef_d_cell_wrap*/

#ifndef struct_tag_AWtPe3jsy9ZjPoQRWWfSzE
#define struct_tag_AWtPe3jsy9ZjPoQRWWfSzE

struct tag_AWtPe3jsy9ZjPoQRWWfSzE
{
  real_T f1[16];
};

#endif                                 /*struct_tag_AWtPe3jsy9ZjPoQRWWfSzE*/

#ifndef typedef_e_cell_wrap
#define typedef_e_cell_wrap

typedef struct tag_AWtPe3jsy9ZjPoQRWWfSzE e_cell_wrap;
...
typedef struct tag_vbWzcivorexA4JA8bWY4YG k_cell;
...
#ifndef struct_tag_cYKlsOB0MhGIMcSWWxyQDE
#define struct_tag_cYKlsOB0MhGIMcSWWxyQDE

struct tag_cYKlsOB0MhGIMcSWWxyQDE
{
  e_cell_wrap _data;
};

#endif                                 /*struct_tag_cYKlsOB0MhGIMcSWWxyQDE*/

#ifndef typedef_s_cYKlsOB0MhGIMcSWWxyQDE
#define typedef_s_cYKlsOB0MhGIMcSWWxyQDE

typedef struct tag_cYKlsOB0MhGIMcSWWxyQDE s_cYKlsOB0MhGIMcSWWxyQDE;

#endif                                 /*typedef_s_cYKlsOB0MhGIMcSWWxyQDE*/
...
#ifndef typedef_InstanceStruct_agstDk5xZXDcm4MOHpL6HC
#define typedef_InstanceStruct_agstDk5xZXDcm4MOHpL6HC
...
typedef struct {
  ...
  real_T (*u0)[7];
  real_T (*b_y0)[42];
} InstanceStruct_agstDk5xZXDcm4MOHpL6HC;

#endif                                 /*typedef_InstanceStruct_agstDk5xZXDcm4MOHpL6HC*/
...
extern void method_dispatcher_agstDk5xZXDcm4MOHpL6HC(SimStruct *S, int_T method,
  void* data);
